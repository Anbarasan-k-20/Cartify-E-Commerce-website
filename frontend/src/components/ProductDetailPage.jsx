...
const ProductDetailPage = () => {
  ...
  const handleBuyNow = () => {
    ...
    navigate("/cart"); // ✅ go to cart/checkout if logged in
  };
...
//           {/* CTA BUTTONS */}
//           <div className="d-flex gap-5">
//             <Button variant="success" className="mt-2 btn-fixed">
//               <IoBagCheckOutline className="me-2" />
//               Buy Now
//             </Button>

//             <Button onClick={handleAddToCart} variant="dark"  className="mt-2 btn-fixed">
//               <GiShoppingCart className="me-2" />
//               Add to Cart
//             </Button>
//           </div>
